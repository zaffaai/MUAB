            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-4">
                  ...
                  />
                  <div>
                    <h3 className="font-bold text-gray-900 dark:text-white">Created by:</h3>
              ...
              <div className="p-4">
                {activeTab === 'overview' ? (
                  <div className="space-y-8">
                    ...
                    {/* Key Benefits */}
                    <div>
                      <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Key Benefits:</h3>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 sticky top-6 space-y-6">
              ...
              <div className="space-y-3">
                <button className="w-full px-6 py-3 bg-purple-600 text-white rounded-xl font-semibold hover:bg-purple-700 transition-all">
                  Buy Now
                </button>
                <button
                  onClick={handleAddToCart}
                  className="w-full px-6 py-3 bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white rounded-xl font-semibold hover:bg-gray-200 dark:hover:bg-gray-600 transition-all"
                >
            ...
            {relatedProducts.map((related) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-bold text-gray-900 dark:text-white mb-1 line-clamp-1 group-hover:text-purple-600">
                    {related.title}
                  </h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
