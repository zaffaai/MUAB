              ...
              {platforms.map((plat) => (
                ...
                >
                  ...
                  <div className="flex items-start gap-3">
                    <div className={`w-12 h-12 shrink-0 rounded-lg bg-${plat.color}-100 dark:bg-${plat.color}-900/30 flex items-center justify-center`}>
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-md p-4">
                <div className="flex gap-3">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-blue-900 dark:text-blue-100 mb-1">MUAB Live Features</p>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-md p-8 border border-gray-200 dark:border-gray-700 space-y-4">
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-md">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-gray-900 dark:text-white">Send Event Reminder</p>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Email attendees before the event starts</p>
                </div>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
