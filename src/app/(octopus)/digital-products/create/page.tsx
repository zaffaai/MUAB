                ...
                sections.map((section, sectionIndex) => (
                  <div key={section.id} className="bg-gray-50 dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                    ...
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-3 flex-1">
                        ...
                        <input
                          ...
                          className="flex-1 px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white font-semibold focus:ring-2 focus:ring-purple-500 transition-all"
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="p-2 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-all disabled:opacity-50"
                        >
                          ...
                          <div className="flex items-start gap-3">
                            <div className={`w-10 h-10 rounded-lg flex items-center justify-center shrink-0 ${
                              ...
                              <i className={`fas ${
                                ...
                                item.type === 'pdf' ? 'fa-file-pdf text-red-600 dark:text-red-400' :
                                item.type === 'video' ? 'fa-video text-purple-600 dark:text-purple-400' :
                                item.type === 'audio' ? 'fa-headphones text-green-600 dark:text-green-400' :
                                item.type === 'doc' ? 'fa-file-word text-yellow-600 dark:text-yellow-400' :
                                item.type === 'image' ? 'fa-image text-pink-600 dark:text-pink-400' :
                                'fa-link text-cyan-600 dark:text-cyan-400'
                              }`}></i>
                            </div>
                            <div className="flex-1">
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                      <p className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Add content to this section:</p>
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                        {[
                          ...
                          <button
                            ...
                            className={`p-3 rounded-lg border-2 border-dashed border-${contentType.color}-200 dark:border-${contentType.color}-800 hover:border-${contentType.color}-400 hover:bg-${contentType.color}-50 dark:hover:bg-${contentType.color}-900/20 transition-all text-center`}
                          >
                            <i className={`fas ${contentType.icon} text-xl text-${contentType.color}-600 dark:text-${contentType.color}-400 mb-2`}></i>
                            <p className={`text-xs font-semibold text-${contentType.color}-700 dark:text-${contentType.color}-300`}>
                              {contentType.label}
                            </p>
                          </button>
                        ))}
